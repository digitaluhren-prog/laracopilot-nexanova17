    ...
    <div class="bg-white rounded-lg shadow-md p-4 md:p-8">
        <form action="{{ route('user.listings.update', $listing->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    ...
                    <div class="relative group">
                        ...
                        @if($index === 0)
                            <span class="absolute top-2 left-2 bg-red-600 text-white text-xs px-2 py-1 rounded font-bold">Kryesore</span>
                        @endif
            ...
            <div class="mb-6">
                ...
                <input type="text" name="title" value="{{ old('title', $listing->title) }}" required class="w-full border border-gray-300 rounded-lg px-4 py-2 md:py-3 focus:ring-2 focus:ring-red-600 focus:border-transparent text-sm md:text-base @error('title') border-red-500 @enderror">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="6" required class="w-full border border-gray-300 rounded-lg px-4 py-2 md:py-3 focus:ring-2 focus:ring-red-600 focus:border-transparent text-sm md:text-base @error('description') border-red-500 @enderror">{{ old('description', $listing->description) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="address" value="{{ old('address', $listing->address) }}" required class="w-full border border-gray-300 rounded-lg px-4 py-2 md:py-3 focus:ring-2 focus:ring-red-600 focus:border-transparent text-sm md:text-base @error('address') border-red-500 @enderror">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $listing->phone) }}" required class="w-full border border-gray-300 rounded-lg px-4 py-2 md:py-3 focus:ring-2 focus:ring-red-600 focus:border-transparent text-sm md:text-base @error('phone') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $listing->email) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 md:py-3 focus:ring-2 focus:ring-red-600 focus:border-transparent text-sm md:text-base @error('email') border-red-500 @enderror">
            ...
            <div class="mb-8">
                ...
                <input type="url" name="website" value="{{ old('website', $listing->website) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 md:py-3 focus:ring-2 focus:ring-red-600 focus:border-transparent text-sm md:text-base @error('website') border-red-500 @enderror">
